...
Centroid NaiveCentroider<ImageT>::doApply(ImageT const& image, int x, int y, double background) const {
...
#define MAKE_CENTROIDERS(IMAGE_T) \
                template class NaiveCentroider<lsst::afw::image::Image<IMAGE_T> >;
